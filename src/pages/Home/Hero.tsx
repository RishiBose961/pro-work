      ...
      <div className=" grid grid-cols-1 lg:grid-cols-3">
        ...
        <div className="col-span-2 px-6 py-12 text-left">
          ...
          <div className=" grid grid-cols-2 lg:grid-cols-5 gap-4 mt-4">
            <AnimatedText textitle={"Linkdin"} img={<Linkedin/>} url={"https://www.linkedin.com/in/rishi-bose%F0%9F%98%87-4934ba252/"}/>
            <AnimatedText textitle={"GitHub"} img={<GithubIcon/>} url={"https://github.com/RishiBose961"}/>
            <AnimatedText textitle={"Twitter"} img={<X/>} url={"https://x.com/IamRishi31"}/>
            <AnimatedText textitle={"Youtube"}img={<Youtube/>} url={"https://www.youtube.com/@darkillerlivegaming"}/>
          </div>
        </div>
      </div>
    </div>
